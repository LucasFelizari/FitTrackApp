...
export function Exercise() {
    ...
    const [sendindRegister, setSendindRegister] = useState(false);
    ...
    async function fetchExerciseDetails() {
        try {
            ...
            const title = isAppError ? error.message : 'Erro ao carregar o exercício';
